...
export class ProductSelectorComponent {
 ...
 choose(event:MatAutocompleteSelectedEvent){const p=this.products().find(x=>x.id===event.option.value);if(p){this.selected.emit(p);this.search.setValue(p.name,{emitEvent:false});}}
}
