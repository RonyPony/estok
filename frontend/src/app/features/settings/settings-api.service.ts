...
export interface SettingsRequest {name:string;currency:string;country:string;timeZone:string;allowNegativeStock:boolean;defaultTaxRate:number;quoteExpirationDays:number;invoicePrefix:string;quotePrefix:string;legalName?:string|null;taxId?:string|null;phone?:string|null;email?:string|null;address?:string|null;invoiceAdditionalInfo?:string|null;invoiceLogoScale:number;allowDuplicateSaleItems:boolean;}
